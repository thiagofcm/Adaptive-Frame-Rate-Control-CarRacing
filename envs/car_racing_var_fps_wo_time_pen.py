...
class CarRacing_VarFramerate_WO_Time_Pen(CarRacing):
    """
    ## Description
...
register(
    id="CarRacing_VarFramerate_WO_Time_Pen",
    entry_point="envs.car_racing_var_fps_wo_time_pen:CarRacing_VarFramerate_WO_Time_Pen",
