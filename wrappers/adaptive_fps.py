...
class AdaptiveFPSWrapper(gym.Wrapper):
    def __init__(self, env, nav_model_path, frame_cost=0.0, budget=50, device="cpu"):
        super().__init__(env)
        ...
        self.observation_space = spaces.Box(
            ...
            shape=(self.n_image + self.n_scalars,),                 # (36866,)
            dtype=np.float32,
        )
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.current_obs = self._get_augmented_obs(observed_frame)  # augmented (36866,) for the FPS policy
    ...
    def step(self, fps_action):
        ...
        self.current_obs = self._get_augmented_obs(self.last_sampled_obs)
