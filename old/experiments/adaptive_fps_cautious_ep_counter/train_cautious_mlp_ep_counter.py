# Feedforward (no-LSTM) ablation of train_cautious_lstm_ep_counter.py -- same wrapper,
# same reward, same obs, same hyperparameters; only the Agent architecture and the
# (now plain, non env-grouped) minibatching differ. Used to isolate whether recurrence/
# BPTT is adding training difficulty on top of the task itself.
import os
...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}_mlp_fc_{args.frame_cost}_bud_{args.budget}_{date_str}"
