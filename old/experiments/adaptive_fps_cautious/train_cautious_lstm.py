...
from wrappers.adaptive_fps_cautious_wrapper import AdaptiveFPS_Cautious_Wrapper
...
def make_env(env_id, nav_model_path, frame_cost, budget, max_episode_steps, device):
    def thunk():
        ...
        env = AdaptiveFPS_Cautious_Wrapper(env, nav_model_path, device, frame_cost, budget)
        return env
    return thunk
