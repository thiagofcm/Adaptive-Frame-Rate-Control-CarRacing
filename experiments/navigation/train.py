...
class Args:
    ...
    env's Box2D-physics + render + preprocessing cost runs concurrently across processes
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        if iteration % 50 == 0 or iteration == args.num_iterations:
            ckpt_path = f"runs/{run_name}/agent_step{global_step}.pt"
            torch.save({
                "iteration": iteration,
