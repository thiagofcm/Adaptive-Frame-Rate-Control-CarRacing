...
def make_env(env_id, idx,nav_model_path, capture_video, run_name):
    def thunk():
        ...
        env = HighestFPSWrapper(env, nav_model_path)
        return env
    return thunk
...
if __name__ == "__main__":
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, i, nav_model_path, args.capture_video, run_name) for i in range(args.num_envs)],
    )
